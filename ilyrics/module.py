...
# ## Some code grabbed from github.com/SwagLyrics/SwagLyrics-For-Spotify
# # ------------------------------------------------------
...
# ## Getting and extracting to Node.js App
# song_a, artist_a = argv
# ## Setting stripped var
# stripped = stripper(song_a, artist_a)
# ## Outputtting the stripped value
print('test')
sys.stdout.flush()